...
import { useMenuRoutes } from '@/config/adminMenus'
...
export default function AdminLayout({ children }: { children: ReactNode }) {
  ...
  const themeLabels: Record<string, string> = {
    dark: t('layout.darkMode'),
    light: t('layout.lightMode'),
    system: t('layout.followSystem'),
  }
      ...
      <div className="admin-layout" data-theme={resolved}>
        <ProLayout
          ...
          actionsRender={() => [
            ...
            <Tooltip key="help" title={t('layout.docs')}>
